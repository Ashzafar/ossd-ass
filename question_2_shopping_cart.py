...
class Product:
    ...
    #def log(self):  # every method needs a parameter, in case none needed, pass "self"
        #print(self.products["laptop"][2])  # one has to give name of key then index of "key:tuple" pair element
...
def __main__():
    ...
    while(True):
        ...
        match opt:
            case 1:
                selection = int(input("This is your shopping cart, choose items to buy: 1.laptops 2.bikes 3.pens 4.game passes 5.daraz recharge 6.bags\n"))
